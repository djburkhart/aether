...
namespace Sce.Atf.Controls.Adaptable.Graphs
{
    ...
    public static class Graphs
    {
        ...
        /// <summary>
        /// Gets the "outgoing" nodes that connect to the given node via an outgoing edge.</summary>
        ...
        /// <summary>
        /// Gets the "incoming" nodes that connect to the given node via an incoming edge.</summary>
