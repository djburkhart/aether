...
// Modified 2026 by Resolvora LLC / Aether Engine contributors: GDI+ Matrix conversion
// is compiled only when SYSTEM_DRAWING_COMMON is defined (not part of the portable build).
