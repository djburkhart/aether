...
{
    /// <summary>
    /// Numeric utility methods used by controls</summary>
    public static class NumericUtil
    {
        ...
        /// <summary>
        /// Check if a number is zero</summary>
        /// <param name="value">The number to check</param>
        /// <returns>True iff the number is zero</returns>
        ...
        /// <summary>
        /// Determine if one number is greater than another</summary>
        ...
        /// <summary>
        /// Determine if one number is less than or close to another</summary>
        /// <param name="left">First number</param>
        /// <param name="right">Second number</param>
        ...
        /// <summary>
        /// Determine if two numbers are close in value</summary>
        /// <param name="left">First number</param>
        /// <param name="right">Second number</param>
