...
{
    /// <summary>
    /// Dock.Avalonia factory: document panes (objects, circuit, timeline, level) + tool panes (properties, history).
    ...
    public sealed class EditorDockFactory : Factory
    {
        ...
        public override IRootDock CreateLayout()
        {
            ...
            var documents = new DocumentDock
            {
                ...
                Proportion = 0.62,
                VisibleDockables = CreateList<IDockable>(objects, circuit, timeline, level),
                ActiveDockable = level
            };
